...
======================================= -->
		<div id="featured"> 
			...
			<?php
				$sql= "select codigo,imagem FROM fotos_slide_show  where(fotos_slide_show.empresa=3)";
				...
				while ($row = mysql_fetch_assoc($result)){				
					...
					if($i==0){
						$imagem=$row["imagem"];
			?>
			<a href=""><img width="1000px" height="330px" src="../../upload/imagens/fotos_slide_show/<?php echo $imagem;?>" data-caption="#htmlCaption" /></a>
			<?php 	}
					else{?>
			<a href=""><img width="1000px" height="330px" src="../../upload/imagens/fotos_slide_show/<?php echo $imagem;?>" /></a>
			<?		}?>
			<?	}?>
		</div>
		<!-- Captions for Orbit -->
		<span class="orbit-caption" id="htmlCaption"><strong></strong><a href="#"></a> <em></em></span>
